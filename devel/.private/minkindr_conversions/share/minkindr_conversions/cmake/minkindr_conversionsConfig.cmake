...
if("TRUE" STREQUAL "TRUE")
  set(minkindr_conversions_SOURCE_PREFIX /home/taylorvd/gbplanner2_ws/src/misc/minkindr_ros/minkindr_conversions)
  set(minkindr_conversions_DEVEL_PREFIX /home/taylorvd/gbplanner2_ws/devel/.private/minkindr_conversions)
  ...
  set(minkindr_conversions_INSTALL_PREFIX /home/taylorvd/gbplanner2_ws/install)
...
if(NOT "/home/taylorvd/gbplanner2_ws/src/misc/minkindr_ros/minkindr_conversions/include " STREQUAL " ")
  set(minkindr_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/taylorvd/gbplanner2_ws/src/misc/minkindr_ros/minkindr_conversions/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'minkindr_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/taylorvd/gbplanner2_ws/src/misc/minkindr_ros/minkindr_conversions/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/taylorvd/gbplanner2_ws/devel/.private/minkindr_conversions/lib;/home/taylorvd/gbplanner2_ws/devel/lib;/opt/ros/noetic/lib)
